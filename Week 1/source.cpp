...
int main(){
	...
	//TASK 1: Person* sean = new Person("Sean", "Mags", "ABC", 23);//sean->set_family_name("Not that");//std::string name = sean->get_family_name();//Person* array1 = new Person[385];//array1[13].set_given_name("John");
	//Task 2: create_person_1_and_2();
	double vector1[10] = { 1.5, 3., 4.5, 6., 7.5, 9., 10.5, 12., 13.5, 15. };
	double vector2[10] = { 3., 4.5, 6., 7.5, 9., 10.5, 12., 13.5, 15., 16.5 };	vecsim vs(vector1, vector2, 10);
